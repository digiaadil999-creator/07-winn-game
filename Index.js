...
.auth-box{background:var(--surface);border:1px solid var(--border);border-radius:20px;padding:28px 24px;width:100%;max-width:380px;}
...
.tab-btn{flex:1;padding:9px;border-radius:7px;border:none;background:transparent;color:var(--muted);font-weight:600;cursor:pointer;}
.tab-btn.active{background:var(--border);color:var(--text);}
.input-group{margin-bottom:14px;}
.input-group label{display:block;font-size:0.78rem;color:var(--muted);margin-bottom:6px;text-transform:uppercase;letter-spacing:1px;}
.inp{width:100%;padding:12px 14px;background:var(--card);border:1px solid var(--border);border-radius:10px;color:var(--text);font-size:0.95rem;outline:none;}
.inp:focus{border-color:var(--gold);}
.btn-primary{width:100%;padding:14px;background:var(--gold);color:#0d0d12;border:none;border-radius:10px;font-weight:700;font-size:1rem;cursor:pointer;}
...
.top-bar{background:var(--surface);border-bottom:1px solid var(--border);padding:14px 18px;display:flex;justify-content:space-between;align-items:center;}
.top-bar-logo{font-size:1.1rem;font-weight:800;}
.top-bar-logo span.g{color:var(--green);}
.top-bar-logo span.r{color:var(--red);}
.balance-chip{background:var(--card);border:1px solid var(--border);border-radius:99px;padding:6px 14px;font-weight:700;font-size:0.9rem;}
.logout-btn{padding:7px 16px;background:transparent;border:1px solid var(--border);color:var(--muted);border-radius:8px;cursor:pointer;font-size:0.82rem;}
...
.round-number{font-size:2.2rem;font-weight:800;font-family:'Space Mono',monospace;color:var(--gold);}
...
.progress-fill{height:100%;border-radius:99px;background:var(--gold);transition:width 1s linear;}
.phase-badge{display:inline-block;margin-top:8px;padding:3px 12px;border-radius:99px;font-size:0.75rem;font-weight:600;}
...
.result-card{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:18px;text-align:center;}
...
.result-ball{width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1.2rem;}
...
.payout-result{padding:6px 20px;border-radius:99px;font-weight:700;font-size:0.95rem;display:inline-block;}
...
.bet-card{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:18px;display:flex;flex-direction:column;gap:16px;}
.section-label{font-size:0.7rem;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;}
.color-btns{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;}
.color-btn{padding:14px 8px;border-radius:12px;border:3px solid transparent;cursor:pointer;text-align:center;font-weight:700;font-size:0.9rem;}
...
.num-btn{padding:12px 0;border-radius:10px;border:2px solid var(--border);background:var(--card);cursor:pointer;text-align:center;font-weight:700;position:relative;}
...
.amt-chip{padding:8px 16px;border-radius:99px;background:var(--card);border:1px solid var(--border);cursor:pointer;font-weight:600;font-size:0.85rem;}
.amt-chip.selected{border-color:var(--gold);color:var(--gold);}
.custom-inp{flex:1;min-width:90px;padding:8px 14px;border-radius:99px;background:var(--card);border:1px solid var(--border);color:var(--text);outline:none;}
.bet-summary{font-size:0.8rem;color:var(--muted);text-align:center;min-height:16px;}
.place-btn{width:100%;padding:15px;background:var(--gold);color:#0d0d12;border:none;border-radius:12px;font-weight:700;font-size:1rem;cursor:pointer;}
...
.h-circle{width:36px;height:36px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:0.9rem;}
...
.payout-row{display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid var(--border);}
...
.admin-bar{background:var(--surface);border-bottom:1px solid var(--border);padding:14px 18px;display:flex;justify-content:space-between;align-items:center;}
...
.admin-card h3{font-size:0.7rem;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-bottom:12px;}
.result-setter{display:flex;flex-direction:column;gap:10px;}
.rs-colors{display:flex;gap:8px;}
.rs-btn{flex:1;padding:12px;border-radius:10px;border:2px solid transparent;cursor:pointer;font-weight:700;}
...
.rs-num{padding:12px 0;border-radius:8px;border:2px solid var(--border);background:var(--card);cursor:pointer;text-align:center;font-weight:700;}
.rs-num.selected{border-color:var(--gold);color:var(--gold);}
.rs-set-btn{padding:14px;background:#e74c3c;color:#fff;border:none;border-radius:10px;font-weight:700;cursor:pointer;width:100%;}
...
.bet-item{display:flex;align-items:center;gap:10px;padding:8px 10px;background:var(--card);border-radius:8px;}
...
.pl-btn{padding:4px 10px;border-radius:6px;border:1px solid var(--border);background:var(--card);cursor:pointer;font-size:0.78rem;color:var(--text);}
.pl-btn.add{border-color:var(--green);color:var(--green);}
.pl-btn.remove{border-color:var(--red);color:var(--red);}
.pl-inp{width:60px;padding:4px 8px;border-radius:6px;border:1px solid var(--border);background:var(--card);color:var(--text);font-size:0.78rem;}
...
<div class="screen active" id="authScreen">
  <div class="auth-box">
    ...
    <div class="admin-link">Admin? <a id="adminLinkBtn" style="cursor:pointer;color:var(--gold)">Click here</a></div>
  </div>
</div>
...
<div class="screen" id="gameScreen">
  ...
  <div class="game-content">
    ...
    <div class="bet-card">
      <div>
        ...
        <div class="color-btns">
          <div class="color-btn green-btn" onclick="selectColor('green',this)">Green<span class="color-payout">2x</span></div>
          <div class="color-btn violet-btn" onclick="selectColor('violet',this)">Violet<span class="color-payout">4.5x</span></div>
          <div class="color-btn red-btn" onclick="selectColor('red',this)">Red<span class="color-payout">2x</span></div>
        </div>
      </div>
      <div>
    ...
    <div class="payout-table">
      ...
      <div class="payout-row"><span>Green / Red (color bet)</span><span class="pay-val">2x</span></div>
      <div class="payout-row"><span>Violet (color bet)</span><span class="pay-val">4.5x</span></div>
      <div class="payout-row"><span>Number (0-9)</span><span class="pay-val">9x</span></div>
      <div class="payout-row"><span>0 or 5 (violet number)</span><span class="pay-val">1.5x</span></div>
    </div>
  ...
  <div class="admin-content">
    <div class="admin-card">
      ...
      <div class="result-setter">
        ...
        <button class="rs-set-btn" id="setResultBtn" disabled onclick="adminSetResult()">Set Result</button>
      </div>
    </div>
    <div class="admin-card">
      <h3>Current Round Bets (<span id="betCount">0</span>) - Pool: <span id="poolAmt" style="color:var(--gold)">Rs.0</span></h3>
...
const ROUND_DURATION = 60;
const NUM_COLORS = {0:'violet',1:'red',2:'green',3:'red',4:'green',5:'violet',6:'green',7:'red',8:'green',9:'red'};
...
function handleMsg(msg){
  ...
  if(msg.type==='error'){ document.getElementById('authError').textContent = msg.message; return; }
  ...
  if(msg.type==='betPlaced'){
    ...
    document.getElementById('betSummary').textContent = 'Bet placed! Rs.' + msg.amount + ' - Waiting for result...';
    return;
  }
  if(msg.type==='waitingForResult'){ currentPhase = 'waiting'; updateGamePhaseUI(); return; }
  if(msg.type==='betResult'){ myBalance = msg.balance; updateBalance(); showBetResult(msg); return; }
  if(msg.type==='roundResult'){ showRoundResult(msg.result, msg.round); return; }
  if(msg.type==='newRound'){
    roundNum = msg.round; roundTimeLeft = roundDuration; currentPhase = 'betting'; betPlaced = false;
  ...
  if(msg.type==='adminSuccess'){ document.getElementById('adminStatus').textContent = msg.message; return; }
}
...
function showAdminLogin(){
  ...
  box.innerHTML = '<div class="auth-logo"><h1 style="color:var(--gold)">Admin Panel</h1><p>07 Winn</p></div><div class="input-group"><label>Admin Password</label><input class="inp" type="password" id="adminPassInp" placeholder="Enter admin password"></div><button class="btn-primary" onclick="doAdminLogin()">Enter Admin</button><div class="error-msg" id="authError"></div><div class="admin-link"><a onclick="location.reload()">Back to Player Login</a></div>';
}
...
function updateBalance(){
  document.getElementById('playerBalance').textContent = 'Rs.' + myBalance.toLocaleString('en-IN');
}
...
function updateGamePhaseUI(){
  ...
  if(currentPhase!=='betting'){
    document.getElementById('placeBtn').disabled=true;
    if(!betPlaced) document.getElementById('betSummary').textContent='Betting closed for this round';
  } else if(!betPlaced){ updatePlaceBtn(); }
}
...
function updatePlaceBtn(){
  const ready = (selectedColor||selectedNumber!==null) && selectedAmt && selectedAmt>0 && selectedAmt<=myBalance;
  ...
  if(selectedAmt && (selectedColor||selectedNumber!==null)){
    ...
    document.getElementById('betSummary').textContent = 'Betting Rs.' + selectedAmt + ' on ' + parts.join(' + ');
  }
}
...
function showBetResult(msg){
  ...
  card.innerHTML = '<div style="font-size:0.7rem;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;">Round Result</div><div class="result-balls"><div class="result-ball ' + c + '">' + c.charAt(0).toUpperCase() + '</div><div class="result-ball ' + ballClass + '">' + n + '</div></div><div class="payout-result ' + (won?'win':'lose') + '">' + (won?'Won Rs.' + msg.payout + ' (' + msg.multiplier + 'x)':'Lost - Better luck next time!') + '</div>';
...
function showRoundResult(result, rnd){
  if(!betPlaced){
    ...
    const ballClass=nc==='violet'?'mixed':nc;
    document.getElementById('resultCard').innerHTML = '<div style="font-size:0.7rem;color:var(--muted);letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;">Round Result</div><div class="result-balls"><div class="result-ball ' + c + '">' + c.charAt(0).toUpperCase() + '</div><div class="result-ball ' + ballClass + '">' + n + '</div></div><div style="font-size:0.82rem;color:var(--muted);margin-top:4px;">No bet this round</div>';
...
function checkAdminReady(){
  ...
  if(ready) document.getElementById('adminStatus').textContent='Ready: ' + adminSelColor + ' + ' + adminSelNumber;
}
...
function updateAdminUI(data){
  ...
  else { bl.innerHTML=data.bets.map(b=>'<div class="bet-item"><div class="bet-color-dot" style="background:var(--' + (b.color||'gold') + ')"></div><span>' + b.username + '</span>' + (b.color?'<span style="font-size:0.75rem;color:var(--' + b.color + ')">' + b.color + '</span>':'') + (b.number!==null&&b.number!==undefined?'<span>#' + b.number + '</span>':'') + '<span class="bi-amt">Rs.' + b.amount + '</span></div>').join(''); }
  const pb=document.getElementById('playersTableBody');
  pb.innerHTML=data.players.map(p=>'<tr><td>' + p.username + '</td><td style="color:var(--gold)">Rs.' + p.balance.toLocaleString('en-IN') + '</td><td style="color:var(--muted)">Rs.' + p.totalBet + '</td><td><div class="pl-actions"><input class="pl-inp" id="amt_' + p.username + '" type="number" placeholder="Rs."><button class="pl-btn add" onclick="adminAddBal(\'' + p.username + '\')">+Add</button><button class="pl-btn remove" onclick="adminRemoveBal(\'' + p.username + '\')">-Remove</button></div></td></tr>').join('');
  const hb=document.getElementById('adminHistBody');
  hb.innerHTML=data.history.map(r=>{ const profit=r.totalPool-r.totalPayout; return '<tr><td>#' + r.id + '</td><td style="color:var(--' + r.result.color + ')">' + r.result.color + ' ' + r.result.number + '</td><td>Rs.' + r.totalPool + '</td><td>Rs.' + r.totalPayout + '</td><td class="' + (profit>=0?'hist-profit':'hist-loss') + '">' + (profit>=0?'+':'') + 'Rs.' + profit + '</td></tr>'; }).join('');
}
